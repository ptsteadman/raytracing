...
public class BvhNode {
	 ...
	 */
	public boolean intersects(Ray rayOriginal) {
		...
		Ray ray = new Ray();
		ray.set(rayOriginal.origin, rayOriginal.direction);
		...
		//System.out.println("t Enter" + tEnter);
		//System.out.println("t Exit" + tExit);
